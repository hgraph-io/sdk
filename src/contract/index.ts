...
import HgraphClient, { Contract, ContractOptions, ContractQueryEventsParams } from "../types";
...
export class HgraphContract implements Contract {
  ...
  constructor(options: ContractOptions) {
    ...
    this.contract = new EthersContract('0x0000000000000000000000000000000000000000', options.abi);
  }
